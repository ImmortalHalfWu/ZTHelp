...
public enum MFontAwesomeSolid implements Ikon {
...
//    REFRESH("", "&#xe6a4".);
    ...
    public static MFontAwesomeSolid findByDescription(String description) {
        for (MFontAwesomeSolid font : values()) {
    ...
    MFontAwesomeSolid(String description, char code) {
