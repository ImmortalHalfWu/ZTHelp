...
public class SVGLoaderController {
    ...
    private ScrollPane allGlyphs() {
        ...
        glyphs.forEach(new Consumer<SVGGlyph>() {
            @Override
            public void accept(SVGGlyph glyph) {
//                byteToHex(glyph.getGlyphId());
                System.out.println(glyph.getGlyphId());
                glyph.setSize(16);
            }
        });
